...
public class Hive {
    ...
    public void fillUpExistingEggsFrameFromHive(Date currentDate) {
        //This app will run only once at the beginning of first year.
    ...
    public void fillUpNewAddedEggsFrameInHive(Date getCreationDate) {
        ...
        System.out.println("you have to insert a new frame");
        ...
        if(this.getNumberOfEggsFrame()==3){
            maximumNumberOfFramesToAdd=1;
        } else if(this.getNumberOfEggsFrame()==4){
            maximumNumberOfFramesToAdd=2;
        } else if (this.getNumberOfEggsFrame()==5){
            maximumNumberOfFramesToAdd=1;
        }
